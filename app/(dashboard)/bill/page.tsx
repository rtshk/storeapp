...
import { CirclePlus, Plus, Search, ShoppingCart } from "lucide-react";
        ...
        {value ? (
          <div className="overflow-scroll md:h-[500px] h-[620px]  pt-2 pb-2">
            {value.map((item) => (
             ...
             <Link href={`/bill/createbill`}>
              <Plus className="fixed bottom-38 right-8 bg-gray-200 rounded-full w-11 h-11 p-2 active:scale-90 active:bg-gray-300 transition-all md:bottom-24" />
            </Link>
          ...
          <div className="text-center align-middle h-[450px] w-full flex flex-col items-center justify-center font-semibold ">
            <Link href={`/bill/createbill`}>
              <Plus className="fixed bottom-22 right-8 bg-gray-200 rounded-full w-11 h-11 p-2 active:scale-90 active:bg-gray-300 transition-all md:bottom-14 md:right-14" />
            </Link>
